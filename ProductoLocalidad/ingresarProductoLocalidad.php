        ...
        <h3>Permite asignarle al producto las localidades en las cuales sera ofrecido.</h3>
            ...
            <table width="702" align="center" cellpadding="10" cellspacing="10" border="0" id="id-form">
                ...
                <tr>
                    <td>Categoria:</td>
                    <td>                        
                        <input type="text" readonly="readonly" id="desc_tipo_enviado" class="inp-form" value="<?php echo $descripcion_tipo_pro_enviado ?>"/>                    </td>
                </tr>                
                <tr>  
                    <td>Unidad:</td>
                    <td>                        
                        <input type="text" readonly="readonly" id="desc_unidad_enviad" class="inp-form" value="<?php echo $desc_unidad_enviado. " (".$conv_unidad_enviado.")" ?>"/>                    </td>
                </tr>  
                <tr>
                    ...
                    <td>
                        ...
                        <script>selectInCombo('cmbComuna','desc_comuna')</script>                    </td>
                    </form>
                </tr>
                <tr>
                        ...
                        <th>
                             <form id="formRelacionar" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">                                 
                                 ...
                                 <?php                                  
                                    ...
                                    if(isset($_POST['IdLocalidadSel'])){
                                        $IdLocalidadSel = $_POST['IdLocalidadSel'];
                                    }
                                    //echo "Dato Orde Antes:".$OrdenEnviada;
                                    
                                    if(isset($_POST['OrdenEnvio'])){
                                        $OrdenEnviada = "true";
                                    }
//                                    echo "Dato Orde Des:".$OrdenEnviada."<br>id(".$id.") - Localidad (".$IdLocalidadSel.")";
                                   // echo "<br>id(".$id.") - Localidad (".$IdLocalidadSel.")";
                                    if($OrdenEnviada == "true"){
    ...
    //                                    echo "id(".$id.") - Localidad (".$IdLocalidadSel.")"; 
                                ...
                                <input name="conv_unidadEnv" type="hidden" value="<?php echo $conv_unidad_enviado ?>" />                                               
                                <input name="desc_unidadEnv" type="hidden" value="<?php echo $desc_unidad_enviado ?>" />         
                                <input name="IdLocalidadSel" type="hidden" value="<?php echo $IdLocalidadSel ?>" />         
                        
                                <input name="idRelacionado" type="hidden" value="<?php echo $id ?>" />
                                <input name="OrdenEnvio" type="hidden" value="<?php echo "true" ?>" />
                ...
                <tr>
                    <th width="240">Localidades Asignadas:</th>
                    <td colspan="2">
                        <select name="select3" class="styledselectlarge" multiple="multiple" >
