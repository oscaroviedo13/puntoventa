...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <?php
            ...
            $stock_minimo = $_POST['stock_nuevo'];
            $nombre_producto = $_POST['nombre_producto'];

            
            $a= modificarStockProductoLocalidad($id_producto_localidad, $stock_minimo);	
//            echo 'dato:'.$a;
            if($a != 1){
            ?>
                <script>
        ...
        <meta http-equiv="refresh" content="1; url= ../ProductoLocalidad/stockProductoLocalidad.php?id2=<?php echo $id_producto;?>&nombre2=<?php echo $nombre_producto;?>">   
    </body>
</html>
