...
<body>        
    <div id="content-table-inner">
        <div id="table-conten">
            ...
            <h2>Administracion de descuentos por localidad.</h2>
            <h3>Permite activar y desactivar los descuentos por localidad.</h3>
                ...
                <table border="0" width="1000px" cellpadding="0" cellspacing="0" id="product-table">
                    <tr>
                        ...
                        <th class="table-header-repeat line-left minwidth-2"><a href="">Localidad (Comuna)</a></th>
                      ...
                      <?php 
                            ...
                            $consulta = "SELECT 
                                            ...
                                            nombre_comuna
                                          FROM
                                            view_informacion_descuento_localidad";
                            ...
                            for($i=0;$i<$rs->Recordcount();$i++){ 
                                ...
                                $id_localidad=$rs->fields[2];
                                $descripcion_localidad = $rs->fields[3];
                                ...
                                $nombre_comuna = $rs->fields[12];
                          
                      ?>  
                      <tr>                    
                        <form method="post" enctype="multipart/form-data" action="recibirActivarDescuentoLocalidad.php">
                            <td>
                             ...
                             <td>
                                 <?php echo $descripcion_localidad." (".$nombre_comuna.")";?>
                             </td>
                             <td>
